...
def text_generation(content_types, bullet_points):
    response = openai.ChatCompletion.create(
      ...
      messages=[
            {"role": "system", "content": "You are an expert in the marketing industry. Write a {} based on the bullet points from the message. Make sure it's funny and easy to read. Your slogan is 'Doing it Differently!'. If it's a blog, the word counts should be around 500.".format(content_types)},
